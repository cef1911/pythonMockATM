...
def login_auth_session(accountNumber, userDetails):
    ...
    try:
        ...
        f = open(auth_session_path + str(accountNumber) + ".text", "x")

    except FileExistsError:

        f = open(auth_session_path + str(accountNumber) + ".text", "w")  
...
def logout_auth_session(accountNumber ,userDetails):
    ...
    if os.path.exists(auth_session_path + str (accountNumber) + ".text"):
       os.remove(auth_session_path + str(accountNumber) +".text") 

    else:
        print("File does not exist")

#print(does_account_number_exist(1198137212))
#print(does_account_number_exist(11981877212))
#print(delete(7907784413))
#print(does_email_exist(1198137212, '222Mike@zuri.team'))
#does_email_exist(2614992054)
#print(read(2614992054))

#['newguy', 'test', 'new@aol.com', 'test2', 0]